...
import { AtSign, GithubIcon, InstagramIcon, Linkedin, Share2, YoutubeIcon } from 'lucide-react'
const Page = () => {
  return (
    <div className=''>
      <h1 className='contact-heading top-section'>Connect with me<Share2 className='share'/></h1>
